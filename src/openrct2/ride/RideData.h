...
struct RideTypeDescriptor
{
    ...
    // Object identifier (e.g. "openrct2dev.ride.tilt_a_whirl") whose RideObject provides the vehicle entry
    // for this custom ride type. nullptr for all built-in types.
    const char* CustomParkObjId{ nullptr };
