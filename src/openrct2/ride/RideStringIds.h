...
enum : StringId
{
    ...
    STR_RIDE_NAME_TILT_A_WHIRL = 7100,
    STR_RIDE_DESCRIPTION_TILT_A_WHIRL = 7101,
    STR_RIDE_NAME_FREESTYLE = 7104,
    STR_RIDE_DESCRIPTION_FREESTYLE = 7105,
    STR_FREESTYLE_PROGRAM_LONG = 7106,
    STR_RIDE_NAME_TROIKA = 7109,
    STR_RIDE_DESCRIPTION_TROIKA = 7110,
    STR_RIDE_NAME_GENERIC_ROTATING_FLAT_RIDE = 7111,
    STR_RIDE_DESCRIPTION_GENERIC_ROTATING_FLAT_RIDE = 7112,
