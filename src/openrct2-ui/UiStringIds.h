...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_NEW_CUSTOM_RIDES = 7100,
        STR_NEW_WATER_RIDES = 981,
        STR_CUSTOM_RIDES_TIP = 7101,
        ...
        STR_GUEST_LOGIC_GROUP = 7113,
        STR_GUEST_QUEUE_TOLERANCE = 7114,
        STR_GUEST_QUEUE_TOLERANCE_TIP = 7115,
        STR_GUEST_RIDE_DISTANCE_WEIGHT = 7116,
        STR_GUEST_RIDE_DISTANCE_WEIGHT_TIP = 7117,
        STR_GUEST_INTENSITY_FLOOR = 7118,
        STR_GUEST_INTENSITY_FLOOR_TIP = 7119,
        STR_GUEST_RIDE_MEMORY_PENALTY = 7120,
        STR_GUEST_RIDE_MEMORY_PENALTY_TIP = 7121,
        STR_GUEST_ALLOW_REPEAT_RIDES = 7135,
        STR_GUEST_ALLOW_REPEAT_RIDES_TIP = 7136,
        STR_GUEST_NEEDS_INTERRUPT = 7137,
        STR_GUEST_NEEDS_INTERRUPT_TIP = 7138,
        STR_GUEST_SMART_LEAVER_LOST = 7139,
        STR_GUEST_SMART_LEAVER_LOST_TIP = 7140,
